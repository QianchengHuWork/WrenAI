...
- For Denodo rate, ratio, percentage, conversion rate, success rate, coverage rate, refund rate, share, or any metric calculated as numerator / denominator from counts or summed counts, preserve the expression shape from runtime metric formulas when one is provided, use NULLIF on the denominator, and do not add casts unless the formula explicitly includes them.
