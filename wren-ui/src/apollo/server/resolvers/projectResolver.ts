...
6. For rate, ratio, percentage, conversion rate, success rate, coverage rate, refund rate, share, or any metric calculated as numerator / denominator from counts or summed counts, cast both numerator and denominator to FLOAT before division. Use NULLIF on the denominator to avoid division by zero. Choose numerator and denominator from the semantic model, metric definition, or business formula instruction; do not infer a denominator from similarly named count fields when ambiguous.
