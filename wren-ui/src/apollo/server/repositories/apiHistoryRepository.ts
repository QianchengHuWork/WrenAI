...
export enum ApiType {
  ...
  GET_METRIC_FORMULAS = 'GET_METRIC_FORMULAS',
  CREATE_METRIC_FORMULA = 'CREATE_METRIC_FORMULA',
  UPDATE_METRIC_FORMULA = 'UPDATE_METRIC_FORMULA',
  DELETE_METRIC_FORMULA = 'DELETE_METRIC_FORMULA',
